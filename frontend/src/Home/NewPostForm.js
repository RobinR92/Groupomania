    ...
    render() {
        ...
        return (
            <form action="" className="newpost-form" onSubmit={this.handleSubmit} ref={this.newPostForm}>
                ...
                <h2 className="newpost-form__title">Ajouter un post</h2>

                <div className="newpost-form__input-group">
                    <label htmlFor="content" className="newpost-form__label">Votre message : <span className="required">*</span></label>
                    <textarea name="content" id="content" cols="30" rows="10" className="newpost-form__textarea" value={this.state.fields['content']} onChange={this.handleChange} />
                    {errors['content'] ? (
                ...
                <div className="newpost-form__input-group">
                    <label htmlFor="image" className="newpost-form__label">Ajouter une image :</label>
